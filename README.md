...
* QRCode para a apresentação de *slides*
  ![](https://raw.githubusercontent.com/elipsesoftware/epmanalysisminicourse/master/resources/EPM_Analysis_presentation.png "EPM Analysis slides" {width=100px height=100px})
